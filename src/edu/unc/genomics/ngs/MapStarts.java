...
public class MapStarts extends CommandLineTool {
	
	private static final Logger log = Logger.getLogger(MapStarts.class);
	...
	public static void main(String[] args) {
		new MapStarts().instanceMain(args);
	}
}