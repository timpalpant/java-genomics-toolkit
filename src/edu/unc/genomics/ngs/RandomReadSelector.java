...
public class RandomReadSelector {
	
	private static final Logger log = Logger.getLogger(RandomReadSelector.class);
	...
	public static void main(String[] args) throws IOException {
		RandomReadSelector a = new RandomReadSelector();
		JCommander jc = new JCommander(a);
		jc.setProgramName(RandomReadSelector.class.getSimpleName());
		try {
			jc.parse(args);
