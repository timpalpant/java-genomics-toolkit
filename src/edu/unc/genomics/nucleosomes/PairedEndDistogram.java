...
public class PairedEndDistogram {
	
	private static final Logger log = Logger.getLogger(PairedEndDistogram.class);
	...
	public static void main(String[] args) throws IOException {
		PairedEndDistogram a = new PairedEndDistogram();
		JCommander jc = new JCommander(a);
		jc.setProgramName(PairedEndDistogram.class.getSimpleName());
		try {
			jc.parse(args);
